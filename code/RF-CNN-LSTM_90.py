...
# 获取目标变量 'Global_active_power' 在原始标准化数组中的索引
...
with torch.no_grad():
    for i in range(input_steps, len(test_scaled_filtered)):
        ...
        single_day_true_scaled = test_scaled_filtered[
            i, target_feature_index_filtered]
